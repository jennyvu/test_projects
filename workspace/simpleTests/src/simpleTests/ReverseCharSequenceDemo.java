...
public class ReverseCharSequenceDemo implements CharSequence {
 private String s;

 public ReverseCharSequenceDemo(String s) {
 ...
 public static void main(String[] args) {
     ReverseCharSequenceDemo s =
         new ReverseCharSequenceDemo("Write a class that implements the CharSequence interface found in the java.lang package.");
